...
import 'package:finalcontact/view/widget/noContact.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    if (CachHelper.getData(key: 'isFirst') == true) {
      CachHelper.saveData(key: 'isFirst', value: false);
      sqlDB.generateFirstContact();
      sqlDB.generateLastContact();
    }
  }
                            ...
                            child: Row(
                              ...
                              children: [
                                IconButton(
                                    onPressed: () {
                                      launchUrl(Uri.parse(
                                          "tel://0${snapShot.data![index].number!}"));
                                    },
                                    icon: const Icon(
                                      Icons.call,
                                      color: Color.fromARGB(255, 3, 86, 153),
